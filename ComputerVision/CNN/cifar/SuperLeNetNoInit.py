...
def TrainModel(epochs, show_plots=True):
    ...
    for epoch in trange(max_epochs):
        ...
        with torch.no_grad():
            ...
            if validacc > bestvalAcc:
                ...
                torch.save(MixLeNet.state_dict(),
                       "./checkpoints/SuperLeNetNoInitBest.pt")
        ...
        if epoch % 25 == 24:
            torch.save(MixLeNet.state_dict(),
                       "./checkpoints/SuperLeNetNoInitLast.pt")
    ...
    if show_plots:
        ...
        plt.savefig('./images/SuperLeNetNoInit_Loss.jpg', bbox_inches="tight")
        plt.clf()

        plt.ylabel("loss")
        plt.title('Loss across all batches')
        plt.plot(loss_arr)
        plt.savefig('./images/SuperLeNetNoInit_TLoss.jpg', bbox_inches="tight")
        plt.clf()
        ...
        plt.savefig('./images/SuperLeNetNoInit_Accuracy.jpg', bbox_inches="tight")
        plt.clf()

    torch.save(MixLeNet.state_dict(), "./checkpoints/SuperLeNetNoInitLast.pt")
    MixLeNet.load_state_dict(torch.load("./checkpoints/SuperLeNetNoInitBest.pt"))
    print(
