...
if __name__ == "__main__":
    ...
    for i in tqdm(range(runs),desc = "Progress bar"):
        ...
        # print(i,'1')
        if count%2 == 1:
                pkl.dump(dict_acc_sigma_convergence, open("sigma1225.p","wb"))
        ...
        # print(i,'2')
        if count%2 == 1:
            pkl.dump(dict_acc_jump_sigma_convergence, open("jump_sigma1225.p","wb"))
        ...
        if count%2 == 1:
            pkl.dump(dict_acc_conj_sigma_convergence, open("conj_sigma1225.p","wb"))
        ...
        # print(i,'3')
        if count%2 == 1:
            pkl.dump(dict_acc_sigma_conj_sigma_convergence, open("sigma_conj_sigma1225.p","wb"))
